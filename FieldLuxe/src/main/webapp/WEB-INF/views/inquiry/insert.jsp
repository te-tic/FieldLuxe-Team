...
<div class="main">
	...
	<table class="table" >
    	<tr>
           <td colspan="2"><h3>1:1문의 등록하기</h3></td>
         </tr>
         <tr>
         <td style="width:120px;">작성자</td>
         	<td><input type="text" name="inquiryEmail" value="scall24" readonly /></td>
         </tr>
         <tr>
            <td style="width:120px;">제목</td>
            <td>
            	 <input type="text" name="inquiryTitle" style="width:90%;height:40px;border:none;"placeholder="제목"/>
          </tr> 
          <tr>
            <td>내용</td>
            <td>
            	 <textarea id="summernote" name="inquiryContent" rows="10" cols="80"placeholder="내용을 입력해주세요."></textarea>
            </td>
          </tr> 
      	  <tr>
      	  	<td colspan="2"><input id="subBtn" type="button" value="글 작성" class="btn btn-default" 
      	  		style="text-align:center;display:block;margin:0 auto;background-color:#bab3b9;color:white;
      	  		border:none;" onclick="goWrite(this.form)" />     	
      	  	</td>
      	  </tr>
      	  </table> 
     	</form>      			
